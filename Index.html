    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          ...
          <br>
          <a href="./project.html" class="btn btn-default btn-lg" title="">Masuk</a>
        </div>
      </div>
    </div>
  </div>
...
<footer class="footer-container white-text-container">
  <div class="container">
    <div class="row">
      ...
      <div class="col-xs-12">
        <h3>Dunia Electronik</h3>

        <div class="row">
          <div class="col-xs-12 col-sm-7">
            <p><small>Website created with <a href="https://www.gamelab.id/" title="Create website with free html template">By Gamelab</a>/<a href="https://www.youtube.com/channel/UCIYA0i33C9e_GX_OOg-3exA?view_as=subscriber" title="Beautiful Free Images">@2020 Reserved By:Muhammad Indra Efendi</a></small>
            </p>
          </div>
